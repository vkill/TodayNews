...
import com.kx.todaynews.widget.imagebrowser.DismissFrameLayout;
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
           ...
           // if (view == null) {
                ...
                View  view = View.inflate(context,R.layout.item_image_browser,null);
                      ...
                      //  LayoutInflater.from(context).inflate(R.layout.item_image_browser, container, false);
               // view.setTag(position);
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ToastUtils.showToast(mList.get(position));
                    }
                });
                Glide.with(ImageBrowserActivity.this).load(mList.get(position)).into(imageView);
              //  Glide.with(ImageBrowserActivity.this).load(mList.get(position)).into(imageView);
