...
public interface Api {
  ...
  * 查询 新闻详情 Html 数据的接口
  */
 @GET("article/content/21/1/{group_id}/1/0?iid=44267707161&device_id=57548705831&ac=wifi&channel=tengxun2&aid=13&" +
    ...
    Observable<TextDetailInfo> getArticleDetail(@Path("group_id") String group_id );
}
